...
void MoreTests() {
  ...
  UnrolledLL<int>::iterator itra = a.begin();
  std::list<int>::iterator itrb = b.begin();
  UnrolledLL<int>::iterator itrc = c.begin();
  UnrolledLL<std::string>::iterator itrd = d.begin();
  std::cout << "a, b, c, d: " << *itra << ", " << *itrb << ", " << *itrc << ", " << *itrd << std::endl;
  ++itra;
  ++itrb;
  ++itrc;
  ++itrd;
  ...
  // iterate through the integers and print them out
  std::cout << "the integers from 10->29a" << std::endl;
  for (UnrolledLL<int>::iterator itr = a.begin(); itr != a.end(); itr++) {
    std::cout << " " << *itr;
  }
  std::cout << "the integers from 10->29c" << std::endl;
  for (UnrolledLL<int>::iterator itr = c.begin(); itr != c.end(); itr++) {
    std::cout << " " << *itr;
  }
...
assert (SAME(c,b));
  itra = a.begin();
  itrb = b.begin();
  std::cout << "a, b: " << *itra << ", " << *itrb << std::endl;
  ++itra;
  ++itrb;
  std::cout << "a, b: " << *itra << ", " << *itrb << std::endl;
  ++itra;
  ...
  while (a_iter != a.end()) {
    ...
    if (*a_iter % 3 == 0) {
      ...
      std::cout << "incrimenting" << std::endl;
      a_iter++;
      std::cout << "incrimented" << std::endl;
    }
  }
  std::list<int>::iterator b_iter = b.begin();
  while (b_iter != b.end()) {
