...
// ===================================================================
void MoreTests() {
  /*This test demonstrates the capabilities of the copy function (assignment operator)
  by copying the contents of list a into list b, both of which are unrolled linked lists
  List A Output:
  UnrolledLL, size: 20
  ...
  */
  ...
  std::cout << "Commencing Copy Test" << std::endl << std::endl;
  UnrolledLL<int> a;  
  UnrolledLL<int> b;
  for (int i = 10; i < 30; ++i) {
    a.push_back(i);
  ...
  b=a;
  std::cout << "list a - unrolled" << std::endl << std::endl;
  a.print(std::cout);
  std::cout << std::endl;
  std::cout << "list b - unrolled - copy of a" << std::endl << std::endl;
  b.print(std::cout);
  std::cout << std::endl;

  /*This test demonstrates UnrolledLL class's ability to take in non-integer inputs.
  In this case, we are using strings to generate a list of greetings.
  List C Output:
  UnrolledLL, size: 3
   node:[3] Hello Good-morning Howdy
  */
  std::cout << "Copy Test Successful" << std::endl << std::endl;
  std::cout << "Commencing Type(String) Test" << std::endl << std::endl;
  UnrolledLL<std::string> c;
  c.push_back("Hello");
  c.push_back("Good-morning");
  c.push_back("Howdy");
  std::cout << "list c - unrolled" << std::endl << std::endl;
  c.print(std::cout);
  std::cout << std::endl;
  std::cout << "Type(String) Test Successful" << std::endl;
  std::cout << std::endl;
}
